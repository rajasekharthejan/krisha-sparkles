...
const NAV = [
  ...
  { href: "/admin/bundles", label: "Bundles", icon: <Boxes size={18} /> },
  ...
  { href: "/admin/newsletter", label: "Email Marketing", icon: <Mail size={18} /> },
  { href: "/admin/emails", label: "Email Log", icon: <Mail size={18} /> },
  { href: "/admin/messages", label: "Messages", icon: <MessageCircle size={18} /> },
  { href: "/admin/instagram", label: "Instagram", icon: <Instagram size={18} /> },
  { href: "/admin/tiktok", label: "TikTok", icon: <Music2 size={18} /> },
