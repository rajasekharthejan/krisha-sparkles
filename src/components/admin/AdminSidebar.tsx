...
import {
  ...
  BookOpen, Gift, BarChart3, Boxes, Music2, Users, RefreshCw, Settings, Sparkles, Crown, Video, FlaskConical, LayoutGrid, Eye,
} from "lucide-react";
...
const GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/admin/sections",    label: "Sections",    icon: <Eye size={16} /> },
