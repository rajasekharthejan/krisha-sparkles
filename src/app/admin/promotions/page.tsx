...
import { Plus, Trash2, Tag, ToggleLeft, ToggleRight, Copy, Check, Percent, DollarSign } from "lucide-react";
    ...
    <div style={{ display: "flex", minHeight: "100vh", background: "var(--bg)" }}>
      ...
      <main style={{ flex: 1, padding: "2rem", overflowY: "auto" }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "2rem", flexWrap: "wrap", gap: "1rem" }}>
          ...
          <button onClick={() => setShowForm(true)} className="btn-gold" style={{ fontSize: "0.875rem" }}>
        ...
        {showForm && (
          <div style={{ background: "var(--surface)", border: "1px solid var(--gold-border)", borderRadius: "16px", padding: "1.75rem", marginBottom: "2rem" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "1.5rem" }}>
              <h2 style={{ fontFamily: "var(--font-playfair)", fontSize: "1.2rem", fontWeight: 700, margin: 0 }}>Create Coupon</h2>
              <button onClick={() => { setShowForm(false); setForm(emptyForm); setError(""); }} style={{ background: "none", border: "none", color: "var(--muted)", cursor: "pointer", fontSize: "1.25rem" }}>✕</button>
            </div>
            ...
            <div style={{ display: "flex", gap: "0.75rem", marginTop: "1.5rem", justifyContent: "flex-end" }}>
              <button onClick={() => { setShowForm(false); setForm(emptyForm); setError(""); }} className="btn-gold-outline" style={{ fontSize: "0.875rem" }}>Cancel</button>
